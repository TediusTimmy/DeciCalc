...
B_INCLUDE := -I../libdecmath -IBackwards/include
...
obj/libdecmath/dm_double.o: ../libdecmath/dm_double.c | obj/libdecmath
	$(CC) $(CFLAGS) -c -o obj/libdecmath/dm_double.o ../libdecmath/dm_double.c

obj/libdecmath/dm_muldiv.o: ../libdecmath/dm_muldiv.c | obj/libdecmath
	$(CC) $(CFLAGS) -c -o obj/libdecmath/dm_muldiv.o ../libdecmath/dm_muldiv.c

obj/libdecmath/dm_double_pretty.o: ../libdecmath/dm_double_pretty.c | obj/libdecmath
	$(CC) $(CFLAGS) -c -o obj/libdecmath/dm_double_pretty.o ../libdecmath/dm_double_pretty.c
