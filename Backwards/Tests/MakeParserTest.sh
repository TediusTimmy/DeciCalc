...
cd ../../bin
g++ -o ParserTest -Wall -Wextra -Wpedantic -g --coverage -O0 -I../../../External/googletest/include -I../include -I../../../libdecmath ../Tests/DebuggerTest.cpp ../Tests/ParserTest.cpp ../obj/*.o ../../../External/googletest/lib/libgtest.a ../../../External/googletest/lib/libgtest_main.a ../obj/*.a
