...
cd ../../bin
g++ -o EngineTest -Wall -Wextra -Wpedantic --coverage -O0 -I../../../External/googletest/include -I../include -I../../../libdecmath ../Tests/ExpressionTest.cpp ../Tests/StdLibTest.cpp ../Tests/StatementTest.cpp ../obj/*.o ../../../External/googletest/lib/libgtest.a ../../../External/googletest/lib/libgtest_main.a ../obj/*.a
